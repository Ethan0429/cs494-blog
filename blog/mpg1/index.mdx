...
The code for the game is available on <LinkWithIcon to="https://github.com/ethan0429/cs494-blog/mgp1/pong.cpp" text="GitHub" />, but I'll also go over the implementation here, piece by piece.
